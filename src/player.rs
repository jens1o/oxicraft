...
// let x: MinecraftDouble = 0.0;
// let y: MinecraftDouble = 0.0;
// let z: MinecraftDouble = 0.0;

// let yaw: MinecraftFloat = 0.0;
// let pitch: MinecraftFloat = 0.0;
// let flags: MinecraftSignedByte = 0b0;
// let teleport_id = get_new_teleport_id();

// let mut player_position_and_looks_packet = Packet::from_id_and_data(
//     Varint(0x32),
//     PacketData::Data(super::build_package_data!(
//         x,
//         y,
...
//     )),
// );
// player_position_and_looks_packet.send(&mut self.tcp_stream)?;

// // C->S Teleport Confirm

// let teleport_confirm_package = self.read_data_packet()?;

// assert_eq!(teleport_confirm_package.packet_id, 0x00);

// if let PacketData::Data(mut packet_data) = teleport_confirm_package.data {
//     let given_teleport_id: Varint = packet_data.decode()?;

//     if teleport_id == given_teleport_id {
//         trace!("Teleport IDs matched.");
//     } else {
//         warn!("Teleport IDs didn't matched. Weird client?");
//     }
// }

// // S->C Player Position and Look (once again)
// // telling the client they are ready to spawn
// player_position_and_looks_packet.send(&mut self.tcp_stream)?;
